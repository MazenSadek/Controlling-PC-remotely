...
private:
    ...
    const char* helpMsg;
    std::vector<std::thread> client_threads;                        // A message that provides help/menu information to clients
    void handleCommand(int client, const std::string command);      // Method to handle client commands
