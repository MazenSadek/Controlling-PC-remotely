...
void Server::handleCommand(int client, const std::string command)
{
    if (command.compare("terminal\n") == 0) {
        executeCommand(client, "gnome-terminal");
     } else if (command.compare("calendar\n")==0) {
         executeCommand(client, "gnome-calendar");
     } else if (command.compare("firefox\n")==0){
         executeCommand(client, "firefox");
     } else if (command.compare("nautilus\n")==0){
         executeCommand(client, "nautilus");
     } else if (command.compare("sudoku\n")==0){
         executeCommand(client, "gnome-sudoku");
     } else if (command.compare("calculator\n")==0){
